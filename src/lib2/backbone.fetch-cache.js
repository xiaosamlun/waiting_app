                ...
                function gotFile(file){
                  ...
                  reader.onloadend = function(evt) {
                    ...
                    try {
                      ...
                      // - decode base64 data
                      // - parse JSON string
                      // var decrypted = App.Utils.Encryption.decrypt(evt.target.result);
                      // var decrypted = evt.target.result;
                      // var b = App.Utils.base64.decode(decrypted);
                      // App.Data.InMemory = JSON.parse(b);

                      // App.Data.InMemory = JSON.parse(evt.target.result);
                      Backbone.fetchCache._cache = JSON.parse(evt.target.result);
                      dfd.resolve();
                    } catch(err){
