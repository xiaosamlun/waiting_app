...
(function(root, factory) {
  ...
  var Model = Backbone.Model = function(attributes, options) {
    ...
    // // - just simply add to a list of Models with this URL
    // if(this.get('_id') && this.url){
    //   // Model already created in global state?
    //   if(!App.BackboneModels[this.url]){
    //     App.BackboneModels[this.url] = _.extend({}, Backbone.Events);
    //   }

    //   // Take events that have been on this Model, from another View
    //   this.listenTo(App.BackboneModels[this.url], 'all', function(){
    //     console.info('LISTENTO LISTENTO LISTENTO LISTENTO LISTENTO LISTENTO LISTENTO LISTENTO LISTENTO LISTENTO ');
    //   });

    //   // Emit the same events on every model with that URL
    //   this.on('all', function(){
    //     console.log('triggering on others');
    //     App.BackboneModels[this.url].trigger.bind(this);
    //   }, this);

    //   // Update this model's data as well?
    //   // - listen for 'sync' events that include data?
    //   // - endless loop of updates possible? (verify that the model's don't already match)?

    // }
    // console.error(this.get('_id'));
