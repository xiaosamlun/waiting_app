...
define(function(require, exports, module) {
    ...
    SubView.prototype.createDefaultSurfaces = function(){
        ...
        this.emptyListSurface = new Surface({
            content: '<br /><br />You\'re not connected with anyone!' +
                    '<br /><br /><br /><br />' +
                    'Use the &nbsp; <i class="icon ion-paper-airplane"></i> &nbsp; icon above to invite someone!' +
                    '<br /><br /><br /><br />Or, if you sign-in with Facebook, you\'ll' +
                    '<br />automatically be connected to friends'
                    ,
            size: [undefined, 100],
