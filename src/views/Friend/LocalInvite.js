...
define(function(require, exports, module) {
    ...
    PageView.prototype.createHeader = function(){
        ...
        this.headerContent.CopyCode.on('click', function(){
            ...
            newRCode.populated().then(function(){
                ...
                Utils.Clipboard.copyTo('get Waiting App at practicalguidetomobileapps.com/?i=' + newRCode.get('code'));
    ...
    PageView.prototype.launch_sms = function(phone_number){
        ...
        newRCode.populated().then(function(){
            ...
            var sentence = "get Waiting App! I'm on it now. " + 'practicalguidetomobileapps.com/?i=' + newRCode.get('code');
