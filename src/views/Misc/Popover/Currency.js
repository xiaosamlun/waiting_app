...
define(function(require, exports, module) {
    ...
    PageView.prototype.createContent = function(){
        ...
        this.contentView.BgSurface = new Surface({
            content: '',
            size: [Utils.WindowWidth() * 2, Utils.WindowHeight() * 2], // make sure it covers everything
            properties: {
    ...
    PageView.prototype.inOutTransitionPopover = function(direction){
        ...
        switch(direction){
            case 'hiding':
                ...
                that.popoverContent.PositionMod.setTransform(Transform.translate(0,-2 * Utils.WindowHeight(),0),{
                    duration: 250,
