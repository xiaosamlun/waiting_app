...
define(function(require, exports, module) {
    ...
    /*
     * DragOver View extends Scroll View by adding functionality to enhance the scrolling effects on renderables laid out by Scroll View.
     * @class DragOverView
     * @constructor
     ...
     * @param {Number} [minOpacity=1] There exists a opacity gradient for the renderables of DragOver View. The min opacity corresponds to the opacities at both ends of DragOver View.
     * @param {Number} [maxOpacity=1] There exists a opacity gradient for the renderables of DragOver View. The gradient increases to the max opacity as the surfaces converge towards the middle of DragOver View.
     * @param {Number} [minDepth=1] There exists a Z-translation gradient for the renderables of DragOver View. The min depth corresponds
     to the z-index at both ends of DragOver View.
     * @param {Number} [maxDepth=1] There exists a Z-translation gradient for the renderables of DragOver View. The gradient increases to the max depth as the surfaces converge towards the middle of DragOver View.
     * @param {Number} [lowerBound=0.45] Sets the position to start the Z-translation gradient for the renderables of DragOver View based on screen width or height.
     * @param {Number} [upperBound=0.55] Sets the position to end the Z-translation gradient for the renderables of DragOver View based on screen width or height.
     * @param {Number} [startDamp=0.5] Sets the dampening on the spring that handles the physics associated with initially swiveling the renderables on DragOver View.
     * @param {Number} [endDamp=0.05] Sets the dampening on the spring that handles the physics associated with ending swiveling the renderables on DragOver View.
     * @param {Number} [startPeriod=250] Sets the start period on the spring that handles the physics associated
     * with initially swiveling the renderables on DragOver View.
     * @param {Number} [endPeriod=3000] Sets the end period on the spring that handles the physics associated
     * with ending swiveling the renderables on DragOver View.
     * @param {Number} [rotateRadian=Math.PI/2] Sets the initial degree of offset for the swiveling of the renderables on DragOver View.
     * @param {Number} [rotateOrigin=[0.5,0.5]] Sets the origin of rotation for swiveling of the renderables on DragOver View.
     * @param {Number} [maxVelocity=30] Sets the maximum velocity associated with swiveling of the renderables on DragOver View.
    ...
    function DragOverView (options) {
        ScrollView.apply(this, arguments);
        this.setOptions(DragOverView.DEFAULT_OPTIONS);
    ...
    DragOverView.prototype = Object.create(ScrollView.prototype);
    DragOverView.prototype.constructor = DragOverView;

    DragOverView.DEFAULT_OPTIONS = {
    ...
    /**
     * Helper function for providing a opacity and Z-translation gradient that increases as the position of the renderables converge towards the middle of DragOver View.
     */
    ...
    /**
     * Adjust opacity for renderables for DragOver View
     */
