...
define(function(require, exports, module) {
    ...
    function PageView(params) {
        ...
        // Note input
        this.noteInput = new View();
        this.noteInput.Surface = new InputSurface({
            size: [undefined, 60],
            placeholder: "Notes",
            classes: ['form-input-text-default']
        });
        this.noteInput.add(this.noteInput.Surface);
        this.noteInput.Surface.pipe(that.contentScrollView);
        // this.contentScrollView.Views.push(this.noteInput);
        ...
        this.submitButton.Surface = new Surface({
            size: [undefined, 60],
            content: 'Save Game',
            classes: ['form-button-submit-default','save-game-button-default']
        });
        ...
        this.submitButton.Surface.on('click', function(){
            if(that.params.passed.on_choose){
                that.params.passed.on_choose({
                    note: that.noteInput.Surface.getValue().toString()
                });
            }
        });
